...
public class ScrabbleTournament {
    ...
    public void playMove(Board board, ScrabbleAI player, int playerNumber) throws IllegalMoveException {
        ...
        // This fixes a security hole where the AI player returns an instance of a new class implementing scrabble.ScrabbleMove,
        // which then manipulates the scrabble.Board.
