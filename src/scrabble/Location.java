...
/**
 * A location on the scrabble.Scrabble board, with row and column coordinates. Immutable. Row and column are 0-based from top
 * left.
 */
public class Location {
    ...
    /**
     * Returns a new scrabble.Location which is offset from this by direction. For example, a.neighbor(HORIZONTAL) is the
    ...
    /**
     * Returns a new scrabble.Location which is offset from this by the opposite of direction. For example,
    ...
    /** Returns true if this scrabble.Location is on the board. */
